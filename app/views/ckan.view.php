                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <ul class="list-group">
                        <li class="list-group-item"><button onclick="addNewTab(query_2)" type="button" class="btn btn-modal text-start"><i class="bi bi-box-arrow-down me-1 text-nfdi"></i>Get some Details of Datasets on CKAN1153 such as Datsaset, Description, Title, Date of issue, Publisher, The distribution, And limit results to 100</button></li>
                        <li class="list-group-item"><button onclick="addNewTab(query_3)" type="button" class="btn btn-modal text-start"><i class="bi bi-box-arrow-down me-1 text-nfdi"></i>Get some Details of Datasets Distribution such as Distribution, Description, Title, Format, Media Type, Access URL, Filter results by Format And limit results to 100.</button></li>
                        <li class="list-group-item"><button onclick="addNewTab(query_4)" type="button" class="btn btn-modal text-start"><i class="bi bi-box-arrow-down me-1 text-nfdi"></i>Showing Dataset along with linked distribution such as Dataset, Dataset Title, Distribution, Distribution Title, And limit results to 100.</button></li>
                        <li class="list-group-item"><button onclick="addNewTab(query_5)" type="button" class="btn btn-modal text-start"><i class="bi bi-box-arrow-down me-1 text-nfdi"></i>How many distributions in each dataset? Descending Order</button></li>
                        <li class="list-group-item"><button onclick="addNewTab(query_5)" type="button" class="btn btn-modal text-start"><i class="bi bi-box-arrow-down me-1 text-nfdi"></i>How many distributions in each dataset? Descending Order</button></li>
                      </ul>
